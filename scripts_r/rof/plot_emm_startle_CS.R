...
load('RfittedModels/fit_fpsCS_wAAAA.Rdata')
out_measure <- 'startle (CSs)'
source('R_scripts/model_building/analysis/contrasts_to_load_wAAAA.R')
fitB5 <- fit_fpsCS_wAAAA
rm(fit_fpsCS_wAAAA)
...
lab_names_pos <- c("ext6,csp,AAAB,1 - tst1,csp,AAAB,1" = "rAAAB",
                   "ext6,csm,AAAB,1 - tst1,csm,AAAB,1" = '',#"reinstatement AAAB",
                  
                   
                   "ext6,csp,AABB,1 - tst1,csp,AABB,1" = "rAABB",
                   "ext6,csm,AABB,1 - tst1,csm,AABB,1" = '',#"reinstatement AABB",
                   
                   
                   "ext6,csp,AABA,1 - tst1,csp,AABA,1" = "rAABA",
                   "ext6,csm,AABA,1 - tst1,csm,AABA,1" = '',#"reinstatement AABA",
                   
                   "ext6,csp,AAAA,1 - tst1,csp,AAAA,1" = "rAAAA",
                   "ext6,csm,AAAA,1 - tst1,csm,AAAA,1" = '',#"reinstatement AABA",
                   
                   "ext6,csp,AAAB,0 - tst1,csp,AAAB,0" = "cAAAB",      
                   "ext6,csm,AAAB,0 - tst1,csm,AAAB,0" = '',#"control AAAB",    
                  
                   
                   "ext6,csp,AABB,0 - tst1,csp,AABB,0" = "cAABB",     
                   "ext6,csm,AABB,0 - tst1,csm,AABB,0" = '',#"control AABB", 
                   
                   
                   "ext6,csp,AABA,0 - tst1,csp,AABA,0" = "cAABA",
                   "ext6,csm,AABA,0 - tst1,csm,AABA,0" = '',#"control AABA"
                  
                   "ext6,csp,AAAA,0 - tst1,csp,AAAA,0" = "cAAAA",
