# Plot estimates SCR
# run contet_scr_1_model markdown
# or load fitted model from BouCon_All/RfittedModels/
load('RfittedModels/fit_scr_wAAAA.Rdata')
out_measure <- 'scr'
...
lab_names_pos <- c("ext9,AAAB,1 - tst1,AAAB,1" = "rAAAB",
                   "ext9,AABB,1 - tst1,AABB,1" = "rAABB",
                   "ext9,AABA,1 - tst1,AABA,1" = "rAABA",
                   "ext9,AAAA,1 - tst1,AAAA,1" = "rAAAA",
                   "ext9,AAAB,0 - tst1,AAAB,0" = "cAAAB",      
                   "ext9,AABB,0 - tst1,AABB,0" = "cAABB",      
                   "ext9,AABA,0 - tst1,AABA,0" = "cAABA",
                   "ext9,AAAA,0 - tst1,AAAA,0" = "cAAAA" )
...
# plotGEN + theme(axis.title.y = element_blank(),
...
lab_names_pos <- c("ext9,csp,AAAB,1 - tst1,csp,AAAB,1" = "rAAAB",
                   "ext9,csm,AAAB,1 - tst1,csm,AAAB,1" = '',#"reinstatement AAAB",
                   
                   "ext9,csp,AABB,1 - tst1,csp,AABB,1" = "rAABB",
                   "ext9,csm,AABB,1 - tst1,csm,AABB,1" = '',#"reinstatement AABB",
                   
                   "ext9,csp,AABA,1 - tst1,csp,AABA,1" = "rAABA",
                   "ext9,csm,AABA,1 - tst1,csm,AABA,1" = '',#"reinstatement AABA",
                   
                   "ext9,csp,AAAA,1 - tst1,csp,AAAA,1" = "rAAAA",
                   "ext9,csm,AAAA,1 - tst1,csm,AAAA,1" = '',#"reinstatement AABA",
                   
                  
                   "ext9,csp,AAAB,0 - tst1,csp,AAAB,0" = "cAAAB",      
                   "ext9,csm,AAAB,0 - tst1,csm,AAAB,0" = '',#"control AAAB",    
                   
                   "ext9,csp,AABB,0 - tst1,csp,AABB,0" = "cAABB",     
                   "ext9,csm,AABB,0 - tst1,csm,AABB,0" = '',#"control AABB", 
                   
                   "ext9,csp,AABA,0 - tst1,csp,AABA,0" = "cAABA",
                   "ext9,csm,AABA,0 - tst1,csm,AABA,0" = '',#"control AABA" )

                   "ext9,csp,AAAA,0 - tst1,csp,AAAA,0" = "cAAAA",
