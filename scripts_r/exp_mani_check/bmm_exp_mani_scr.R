...
dat <- droplevels(dat[dat$expPhase %in% c('acq','ext') & dat$bin1 == 9,])
...
set.seed(321)
seed_def <- 321
response_var_def <- 'amplitude_log_rc'
...
b3 <- update(b0, . ~ . - (1 | idNum) + (1 + stimType + trial | idNum), seed = seed_def)
b4 <- update(b0, . ~ . - (1 | idNum) + (1 + stimType * trial | idNum), seed = seed_def, control = list(adapt_delta = .99), iter = 20000)
Sys.time()

tab_model(b0,b1,b2,b3,b4)

b0 <- add_criterion(b1, 'waic')
...
# plot 1
# label contrasts
lab_names_pos <- c("acq_9,csp - acq_9,csm" = "CS+ vs CS- end acq",
                   "ext_9,csp - ext_9,csm" = "CS+ vs CS- end ext",
                   "acq_9,csp - ext_9,csp" = "CS+ acq vs ext",
                   "acq_9,csm - ext_9,csm" = "CS- acq vs ext")
...
# plot 2
# label contrasts
lab_names_pos <- c('acq_9,csp,AAAB,0 - acq_9,csm,AAAB,0' = 'CS+ vs CS- end acq control AAAB',
                   'ext_9,csp,AAAB,0 - ext_9,csm,AAAB,0' = 'CS+ vs CS- end ext control AAAB', # 'cs discrimination end extinction',
                   'acq_9,csp,AAAB,0 - ext_9,csp,AAAB,0' = 'CS+ acq vs ext control AAAB', # 'cs+ change acq to ext',
                   'acq_9,csm,AAAB,0 - ext_9,csm,AAAB,0' = 'CS- acq vs ext control AAAB',  # cs- change acq to ext
                   
                   # AABB, control group
                   'acq_9,csp,AABB,0 - acq_9,csm,AABB,0'= 'CS+ vs CS- end acq control AABB', # cs discrimination end acquisition
                   'ext_9,csp,AABB,0 - ext_9,csm,AABB,0'= 'CS+ vs CS- end ext control AABB', # cs discrimination end extinction
                   'acq_9,csp,AABB,0 - ext_9,csp,AABB,0'= 'CS+ acq vs ext control AABB', # cs+ change acq to ext
                   'acq_9,csm,AABB,0 - ext_9,csm,AABB,0' = 'CS- acq vs ext control AABB',  # cs- change acq to ext
                   
                   # AABA, control group
                   'acq_9,csp,AABA,0 - acq_9,csm,AABA,0'= 'CS+ vs CS- end acq control AABA', # cs discrimination end acquisition
                   'ext_9,csp,AABA,0 - ext_9,csm,AABA,0'= 'CS+ vs CS- end ext control AABA', # cs discrimination end extinction
                   'acq_9,csp,AABA,0 - ext_9,csp,AABA,0'= 'CS+ acq vs ext control AABA', # cs+ change acq to ext
                   'acq_9,csm,AABA,0 - ext_9,csm,AABA,0'= 'CS- acq vs ext control AABA',  # cs- change acq to ext
                   
                   # AAAB, reinstatement group
                   'acq_9,csp,AAAB,1 - acq_9,csm,AAAB,1' = 'CS+ vs CS- end acq reinstatement AAAB',
                   'ext_9,csp,AAAB,1 - ext_9,csm,AAAB,1' = 'CS+ vs CS- end ext reinstatement AAAB', # 'cs discrimination end extinction',
                   'acq_9,csp,AAAB,1 - ext_9,csp,AAAB,1' = 'CS+ acq vs ext reinstatement AAAB', # 'cs+ change acq to ext',
                   'acq_9,csm,AAAB,1 - ext_9,csm,AAAB,1' = 'CS- acq vs ext reinstatement AAAB',  # cs- change acq to ext
                   
                   # AABB, reinstatement group
                   'acq_9,csp,AABB,1 - acq_9,csm,AABB,1'= 'CS+ vs CS- end acq reinstatement AABB', # cs discrimination end acquisition
                   'ext_9,csp,AABB,1 - ext_9,csm,AABB,1'= 'CS+ vs CS- end ext reinstatement AABB', # cs discrimination end extinction
                   'acq_9,csp,AABB,1 - ext_9,csp,AABB,1'= 'CS+ acq vs ext reinstatement AABB', # cs+ change acq to ext
                   'acq_9,csm,AABB,1 - ext_9,csm,AABB,1' = 'CS- acq vs ext reinstatement AABB',  # cs- change acq to ext
                   
                   # AABA, reinstatement group
                   'acq_9,csp,AABA,1 - acq_9,csm,AABA,1'= 'CS+ vs CS- end acq reinstatement AABA', # cs discrimination end acquisition
                   'ext_9,csp,AABA,1 - ext_9,csm,AABA,1'= 'CS+ vs CS- end ext reinstatement AABA', # cs discrimination end extinction
                   'acq_9,csp,AABA,1 - ext_9,csp,AABA,1'= 'CS+ acq vs ext reinstatement AABA', # cs+ change acq to ext
                   'acq_9,csm,AABA,1 - ext_9,csm,AABA,1'= 'CS- acq vs ext reinstatement AABA')  # cs- change acq to ext
